...
\hypersetup{breaklinks=true,
            bookmarks=true,
            pdfauthor={},
            pdftitle={Früherer Stand der OParl Schnittstellen-Spezifikation (Entwurf 16.6.2014), eine Grundlage von OpenGovLD},
            colorlinks=true,
            urlcolor=blue,
            linkcolor=magenta,
            pdfborder={0 0 0}}
...
\hyperdef{}{jsonldux5foparlux5fex1}{\label{jsonldux5foparlux5fex1}}
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{\{}
...
\hyperdef{}{jsonldux5foparlux5fex2}{\label{jsonldux5foparlux5fex2}}
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{\{}
...
\hyperdef{}{jsonldux5foparlux5fex3}{\label{jsonldux5foparlux5fex3}}
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{\{}
    \DataTypeTok{"@id"}\FunctionTok{:} \StringTok{"https://oparl.example.org/"}\FunctionTok{,}
...
\hyperdef{}{objektlistenux5fex7}{\label{objektlistenux5fex7}}
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{\{}
    \DataTypeTok{"@type"}\FunctionTok{:} \StringTok{"oparl:System"}\FunctionTok{,}
...
\hyperdef{}{ausnahmebehandlung}{\subsection{Ausnahmebehandlung}\label{ausnahmebehandlung}}
...
\hyperdef{}{schema}{\section{Schema}\label{schema}}
...
\hyperdef{}{bodyux5fexux5fcontext}{\label{bodyux5fexux5fcontext}}
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{\{}
    \DataTypeTok{"@language"}\FunctionTok{:} \StringTok{"de"}\FunctionTok{,}
...
\hyperdef{}{legislativeux5ftermux5fex2}{\label{legislativeux5ftermux5fex2}}
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{\{}
    \DataTypeTok{"@context"}\FunctionTok{:} \FunctionTok{\{}
